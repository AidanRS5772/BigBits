...
The Big Integer implementations come in signed and unsigned variants (UBitInt, UBitIntStatic, BitInt, BitIntStatic). The floating point implementations also come in stack and heap defined versions (BitFloat, BitFloatStatic). The implementations allow the programmer to make the decision for how exactly they would like things to function and what trade-offs they want.
